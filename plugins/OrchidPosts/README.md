...
check out the {{ anchor('OrchidTaxonomies') }} plugin, and refer to the [OrchidStarter repo](https://github.com/JavaEden/OrchidStarter/blob/master/src/orchid/resources/config/taxonomies.yml)
